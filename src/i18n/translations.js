...
const en = {
  ...
  actions: {
    ...
    downloadPricingGuide: 'Download Pricing Guide',
    downloadFullPricingGuide: 'Download Full Pricing Guide',
    bookDiscoveryCall: 'Book Discovery Call',
    startQuote: 'Start Instant Quote',
  ...
  footer: {
    description: 'Your trusted partner for digital transformation. We craft innovative web, mobile, and SaaS solutions tailored for the Ethiopian market and beyond.',
    company: 'Company',
    connect: 'Connect',
    rights: '© 2026 NovaTech Digital Agency. All rights reserved.',
    links: {
  ...
  liveChat: {
    ...
    prompts: {
      home: 'Hi NovaTech, I am exploring your services and want quick guidance on the right package.',
      web: 'Hi NovaTech, I need help choosing the right web development package for my business.',
      mobile: 'Hi NovaTech, I am planning a mobile app and want a delivery estimate.',
      saas: 'Hi NovaTech, I want to discuss SaaS options for my organization.',
      additional: 'Hi NovaTech, I need a custom quote for additional services and add-ons.',
      caseStudies: 'Hi NovaTech, I reviewed your case studies and want to discuss similar outcomes for my business.',
      portfolio: 'Hi NovaTech, I am browsing your portfolio and want recommendations for my industry.',
      instantQuote: 'Hi NovaTech, I am completing the quote wizard and need help validating scope and budget.',
      bookCall: 'Hi NovaTech, I want help choosing the best discovery call slot and agenda.',
  ...
  seo: {
    defaultTitle: 'NovaTech - Digital Agency | Web, Mobile and SaaS Solutions',
    defaultDescription: 'NovaTech designs and builds conversion-ready websites, mobile apps, and SaaS systems for organizations in Ethiopia and beyond.',
  },
};
...
const amOverrides = {
  ...
  seo: {
    defaultTitle: 'NovaTech - ዲጂታል ኤጀንሲ | ዌብ፣ ሞባይል እና SaaS መፍትሄዎች',
    defaultDescription: 'NovaTech ለኢትዮጵያ እና ከዚያ በላይ ድርጅቶች የዌብ፣ የሞባይል እና SaaS መፍትሄዎችን ይገነባል።',
  },
};
...
const omOverrides = {
  ...
  seo: {
    defaultTitle: 'NovaTech - Agency Dijitaalaa | Furmaata Web, Mobile fi SaaS',
    defaultDescription: 'NovaTech dhaabbilee Itoophiyaa fi alatti websaayitii, appii mobile fi sirna SaaS ijaara.',
  },
};
