...
const en = {
  ...
  footer: {
    description: 'AI-first automation consultancy delivering custom agentic workflows, private model deployments, and resilient execution layers for operations-heavy teams.',
    company: 'Company',
    connect: 'Connect',
    ...
    links: {
      ...
      additionalServices: 'Engineering Delivery Layer',
      aboutUs: 'Methodology',
      linkedin: 'LinkedIn',
    },
  },
